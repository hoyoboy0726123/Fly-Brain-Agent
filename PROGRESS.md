...
3. **CI status** — the workflow runs on the pushed branch; claim "CI passing" only after GitHub Actions reports a green run (checked in the final report).
