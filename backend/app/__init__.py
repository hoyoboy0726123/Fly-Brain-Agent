...
- INTERVENTION (P7.2)    -> app.simulation.intervention (COMPUTATIONAL FIRING SUPPRESSION in the
                            engine), app.behavior.intervention (targets), app.api.intervention (A/B)
